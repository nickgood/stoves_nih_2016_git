...
```{r}
  t_range$t_min[which(t_range$id == "1A" & t_range$rep == 1)] <- 14.6
  t_range$t_max[which(t_range$id == "1A" & t_range$rep == 1)] <- 82.8
  
  t_range$t_min[which(t_range$id == "1A" & t_range$rep == 2)] <- 11.6
  t_range$t_max[which(t_range$id == "1A" & t_range$rep == 2)] <- 59.2

  t_range$t_min[which(t_range$id == "8A" & t_range$rep == 1)] <- 19.9
  t_range$t_max[which(t_range$id == "8A" & t_range$rep == 1)] <- 86.6
  
  t_range$t_min[which(t_range$id == "8A" & t_range$rep == 2)] <- 19.7
  t_range$t_max[which(t_range$id == "8A" & t_range$rep == 2 )] <- 55
```

...
```{r carbs_bg_timeseries, echo=FALSE, fig.height = 16, fig.width = 16}
 bg %>%
    dplyr::filter(!is.na(conc)) %>%
...
```{r carbs_samples_timeseries, echo=FALSE, fig.height = 16, fig.width = 16}
 carbs_samples %>%
    dplyr::filter(!is.na(conc)) %>%
    dplyr::left_join(dplyr::select(samples, id, date), by = 'id') %>%
    ggplot(aes_string(x = "date", y = "conc")) +
...
```{r carbs_test_bg_conc, echo=FALSE, fig.height = 16, fig.width = 16}
  carbs_merged %>%
...
```{r carbs_stovetype, echo=FALSE, fig.height = 50, fig.width = 16}
  carbs_samples_p <-
    carbs_samples %>%
...
```{r carbs_fueltype, echo=FALSE, fig.height = 50, fig.width = 16}
  carbs_samples_p %>%

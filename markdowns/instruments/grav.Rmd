...
```{r pm_calibration_wgt_timeseries, echo=FALSE, fig.height = 4, fig.width = 8}
  grav %>%
...
```{r pm_wgtoom_filter_timeseries, echo=FALSE, fig.height = 4, fig.width = 8}
  grav %>%
...
```{r pm_blank_timeseries, echo=FALSE, fig.height = 4, fig.width = 8}
 blanks %>%
    dplyr::filter(!is.na(val)) %>%
...
```{r pm_bg_timeseries, echo=FALSE, fig.height = 4, fig.width = 12}
 bg %>%
    dplyr::filter(!is.na(val)) %>%
...
```{r pm_samples_timeseries, echo=FALSE, fig.height = 4, fig.width = 14}
 grav_samples %>%
    dplyr::filter(!is.na(val)) %>%
    dplyr::left_join(dplyr::select(samples, id, date), by = 'id') %>%
    ggplot(aes_string(x = "date", y = "val")) +
...
```{r pm_test_bg_conc, echo=FALSE, fig.height = 4, fig.width = 6}
  grav_merged %>%
...
```{r pm_stovetype, echo=FALSE, fig.height = 6, fig.width = 16}
  grav_samples_p <-
    grav_samples %>%
...
```{r pm_fueltype, echo=FALSE, fig.height = 6, fig.width = 16}
  grav_samples_p %>%

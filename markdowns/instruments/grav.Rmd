...
conclusions: background to invesigate: G7 (filter weights possibly switched)
...
conclusions: Check G7 (filter out for now)
...
## table: percent of lab backgrounds below lod for chemical analysis
...
```{r pm_stovetype, echo=FALSE, fig.width=10}
  grav_merged_p <-
    grav_merged %>%
...
```{r pm_fueltype, echo=FALSE, fig.width=10}
  grav_merged_p %>%
...
## table: percent of burns below lod for analysis

...
```{r}
  ...
  pah_add1 <- readr::read_csv(file = "../data/pah/add_on_20180521.csv",
                              col_types = cols(pol = col_character(),
                                               id = col_character(),
                                               filter_type = col_character(),
                                               val = col_double(),
                                               lod = col_character()))

  pah_add2 <- readr::read_csv(file = "../data/pah/add_on_20180525.csv",
                              col_types = cols(pol = col_character(),
                                               id = col_character(),
                                               filter_type = col_character(),
                                               val = col_double(),
  ...
  pah_add3 <- readr::read_csv(file = "../data/pah/add_on_20180531.csv",
                              col_types = cols(pol = col_character(),
                                               id = col_character(),
                                               filter_type = col_character(),
                                               val = col_double(),
  ...
  pah_add4 <- readr::read_csv(file = "../data/pah/add_on_20180531_2.csv", 
                              col_types = cols(pol = col_character(),
                                               id = col_character(),
                                               filter_type = col_character(),
                                               val = col_double(),
  ...
  pah_add <-
    pah_add1 %>%
    dplyr::bind_rows(pah_add2) %>%
    dplyr::bind_rows(pah_add3) %>%
    dplyr::bind_rows(pah_add4)

  saveRDS(pah_add, file = "../r_data/pah_add.RDS")

  duplicates <- readr::read_csv(file = "../data/pah/duplicates_20180601.csv",
  ...
  saveRDS(duplicates, file = "../r_data/pah_duplicates.RDS")
```
...
```{r}
  saveRDS(load_wbt_data(), file = "../r_data/wbt_data.RDS")
```

```{r}
  saveRDS(load_field_data(), file = "../r_data/field_data.RDS")
```

```{r} 
  saveRDS(load_rose_data(), file = "../r_data/rose_field_data.RDS")
```

```{r} 
  saveRDS(load_gbd_data(), file = "../r_data/gbd.RDS")
```
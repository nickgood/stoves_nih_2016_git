...
```{r, echo=FALSE}
  ...
  p1 <-
    ...
    ggplot(aes(x = stove, y = val)) +
      ...
      annotate("text", x = 2, y = 200, label = "XXX", size = 5) +
  ...
  p2 <-
    ...
    ggplot(aes(x = stove, y = val)) +
      ...
      scale_y_continuous(limits = c(0, 200)) +
      annotate("text", x = 2, y = 200, label = "XXX", size = 5) +
      annotate("text", x = 4, y = 200, label = "XXX", size = 5) +
      theme_bw() +
      scale_fill_manual(values = col_vector) +
      theme(text = element_text(size = 20),
            axis.text.y = element_text(size = 18),
...
```{r, echo=FALSE}
  p4 <-
    ...
    ggplot(aes(x = stove, y = val)) +
        ...
        annotate("text", x = 1, y = 2000, label = "XXX", size = 5) +
        annotate("text", x = 2, y = 2000, label = "XXX", size = 5) +
        theme_bw() +
        theme(text = element_text(size = 20),
              axis.title.y = element_text(size = 16),
              axis.text.y = element_text(size = 18),
  ...
  p5 <-
    ...
    ggplot(aes(x = stove, y = val)) +
        ...
        annotate("text", x = 1, y = 600, label = "XXX", size = 5) +
        theme_bw() +
        theme(text = element_text(size = 20),
              axis.text.y = element_text(size = 18),
              strip.text.x = element_blank(),
...
```{r, echo=FALSE}
  p7 <-
    ...
    ggplot(aes(x = stove, y = val)) +
      ...
      annotate("text", x = 2, y = 40, label = "XXX", size = 5) +
  ...
  p8 <-
    ...
    ggplot(aes(x = stove, y = val)) +
      ...
      annotate("text", x = 1, y = 20, label = "XXX", size = 5) +
      theme_bw() +
      theme(text = element_text(size = 20),
            axis.text.x = element_blank(),
            axis.title.x = element_blank(),
  ...
  p9 <-
    ...
    ggplot(aes(x = stove, y = val)) +
      ...
      annotate("text", x = 1, y = 2, label = "XXX", size = 5) +
      theme_bw() +
      theme(text = element_text(size = 20),
            axis.text.y = element_text(size = 18),
            axis.title.y = element_blank(),

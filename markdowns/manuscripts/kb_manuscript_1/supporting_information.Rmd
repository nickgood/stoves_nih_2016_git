...
```{r load_libraries, echo=FALSE, message=FALSE}
  ...
  pacman::p_load(tidyverse, patchwork, knitr, kableExtra, forcats, patchwork,
...
```{r, fig.width=14, fig.height=10}
  samples %>%
    ...
    grid.brackets(200, 400, 550, 400, lwd = 2, col = "black")
```
...
# 4. List of carcinogenic compounds

# 5. List of stove-fuel categories

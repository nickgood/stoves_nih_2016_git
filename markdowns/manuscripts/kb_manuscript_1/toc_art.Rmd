...
```{r}
  photos <- tibble::data_frame(stove = c("a",
                                         ...
                                         "j",
                                        "k"),
                              loc = c("stove_images/three_stone.png",
                                      "stove_images/chulha.png",
                                      "stove_images/rocket_elbow.png",
                                      "stove_images/chimney.png",
                                      "stove_images/fan_rocket.png",
                                      "stove_images/gasifier.png",
                                      "stove_images/metal_charcoal.png",
                                      "stove_images/ceramic_charcoal.png",
                                      "stove_images/wick_kerosene.png",
                                      "stove_images/pressure_kerosene.png",
                                      "stove_images/lpg.png"))
```
...
```{r, fig.height=4.76, fig.width=8.47}
 pols_p %>%
    ggplot(aes(x = pm_mass, y = co)) +
       geom_image(aes(image = loc), size = 0.1) +

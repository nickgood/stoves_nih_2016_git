...
```{r}
  ...
  write_csv(missing_front_puf, "../../missing_data/missing_front_puf.csv")
```
...
```{r}
  missing_back_puf <-
    pah_merged %>%
    dplyr::filter(is.na(val), test_type == "test", filter_type == "back puf") %>%
    dplyr::select(pol, id) %>%
    dplyr::arrange(id)

  write_csv(missing_back_puf, "../../missing_data/missing_back_puf.csv")
```
...
```{r}
  ...
  write_csv(missing_backgrounds, "../../missing_data/missing_backgrounds.csv")
```
...
```{r}
  ...
  write_csv(missing_blanks, "../../missing_data/missing_blanks.csv")
```

...
notes: need to update this code to only remove pollutants depending on molecular weight - wait until Pierre sends next round of data
...
note: for now, ignore NAs when summing - if all values are below bg then set bg equal to below

...
* Next we'll load the pollutant data we're interested in. In this case we're going to look at the CO data:
...
```{r, echo=TRUE, warning=FALSE, message=FALSE, results='markup', cache=FALSE}
  save(background_means, file = "../r_files/background_co.Rda")
```

...
```{r, echo=TRUE, warning=FALSE, message=FALSE, results='markup', cache=FALSE}
  pol_properties <- tibble::data_frame(pol = c ("co2", "co", "ch4", "ec", "oc",
                                                ...
                                                "glucose", "mannose",
                                                "glycerol", "threitol",       #71
                                                "mannitol", "arabinose",
                                                "xylose", "wsoc", "sodium",
                                                "ammonium", "potassium",
                                                "magnesium", "calcium",     #80
                                                "chloride", "nitrite",
                                                "nitrate", "sulfate",  #84
                                                "formaldehyde",
                                                "acetaldehyde",
                                       ...
                                       num_c = c(1, 1, 1, NA, NA, NA, NA, NA, #8
                                                 2, 2, 3, 3, 4, 4, 2, #15
                                                 4, 4, 4, 4, 5, 5, 5, 5, 5, #24
                                                 5, 5, 6, 6, 5, 6, 6, 7, 7, #33
                                                 7, 6, 6, 7, 7, 7, 8, 8, 7, #42
                                                 8, 8, 8, 8, 8, 8, 8, 9, 9,
                                                 10, 9, 9, 9, 9, 9, 9, 10,
                                                 9, 10, 10, 10, 6, 6, 6, 6,
                                                 6, 6, 3, 4, 6, 5, 5, NA, 0,
                                                 ...
                                                 2, 3, 3, 3, 4, 4, 4, 4, 7,
                                                 5, 5, 8, 8, 6, 9),
                                       num_h = c(0, 0, 4, NA, NA, NA, NA, NA, #8
                                                 6, 4, 8, 6, 10, 10, #14
                                                 2, 8, 8, 8, 8, 10, 12, 12, #22
                                                 10, 10, 10, 10, 12, 14, 8, #29
                                                 12, 12, 16, 14, 16, 6, #35
                                                 14, 16, 16, 16, 18, 18, #41
                                                 8, 18, 18, 18, 10, 10, #47
                                                 8, 10, 20, 12, 16, 12,
                                                 12, 12, 12, 12, 12, 22,
                                                 12, 14, 14, 14, 10, 10,

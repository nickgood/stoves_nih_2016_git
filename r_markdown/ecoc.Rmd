...
```{r}
  ecoc_merged <- ecoc %>%
                 ...
                 dplyr::mutate(filter_type = ifelse(id == "blank", "blank",
                                                    filter_type),
                               filter_type = ifelse(grepl(".*Blank.*", filter_type),
                                                    "blank", filter_type),
                               filter_type = ifelse(grepl(".*of day.*", filter_type),
                                                    "start_blank", filter_type),
                               filter_type = ifelse(grepl(".*Test.*", filter_type),
                                                    "test", filter_type),
                               filter_type = tolower(filter_type),
                               id = ifelse(grepl(".*blank.*", filter_type),
                                           "blank", id),
                               id = ifelse(grepl(".*start_blank.*", filter_type),
                                           "start_blank", id),
                               id = ifelse(grepl(".*test.*", filter_type),
                                           "test", id)) %>%
...
```{r}
  blanks <- dplyr::filter(ecoc_merged, grepl("^G", id)) %>%
            dplyr::group_by(pol) %>%

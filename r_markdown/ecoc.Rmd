...
```{r, echo=FALSE, warning=FALSE, message=FALSE, results='markup', cache=FALSE, fig.width=12, , fig.height=8}
  ggplot(ecoc_calcs, aes(x= ec_conc, y = oc_conc, size = ec_oc_ratio, colour = stove), na.rm = TRUE) +
    geom_point() +
    scale_y_log10() +
    scale_x_log10() +
    theme_minimal() +
  ...
  ggplot(ecoc_calcs, aes(x= ec_conc, y = oc_conc, size = ec_oc_ratio, colour = fuel), na.rm = TRUE) +
    geom_point() +
    scale_y_log10() +
    scale_x_log10() +
    theme_minimal() +

...
```{r, echo=FALSE, warning=FALSE, message=FALSE, results='markup', cache=FALSE}
  lod_ec <- round(dplyr::filter(blanks, pol == "ec")$lod[1], 3)
  lod_oc <- round(dplyr::filter(blanks, pol == "oc")$lod[1], 3)
  loq_ec <- round(dplyr::filter(blanks, pol == "ec")$loq[1], 3)
  loq_oc <- round(dplyr::filter(blanks, pol == "oc")$loq[1], 3)
```

* The EC limit of detection is `r lod_ec` ($\mu g/cm^2$) and limit of quantification is `r loq_ec` ($\mu g/cm^2$).

* The OC limit of detection is `r lod_oc` ($\mu g/cm^2$) and limit of quantification is `r loq_oc` ($\mu g/cm^2$).

...
```{r, echo=TRUE, warning=FALSE, message=FALSE, results='markup', cache=FALSE}
  test_info <- loadRDS(fuel_burnt_reps, file = "../r_files/test_info.RDS")
  fuel_burnt_reps <- loadRDS(fuel_burnt_reps, file = "../r_files/fuel_burnt_reps.RDS")
  fuel_burnt_test <- loadRDS(fuel_burnt_test, file = "../r_files/fuel_burnt_test.RDS")

...
```{r global_options, include=FALSE}
  knitr::opts_chunk$set(fig.path='figures/', include=FALSE, echo=FALSE, warning=FALSE, message=FALSE, cache=FALSE, results='hide')
...
```{r filter_rep_summary, fig.width = 23,  fig.height = 15}

...
* CO
```{r}
pairwise.t.test(p_data_carbs$mass_per_mass_fuel[p_data_gas$pol == "co"], p_data_carbs$fuel[p_data_gas$pol == "co"], p.adj = "none")
```

* CO2
```{r}
pairwise.t.test(p_data_carbs$mass_per_mass_fuel[p_data_gas$pol == "co2"], p_data_carbs$fuel[p_data_gas$pol == "co2"], p.adj = "none")
```

* CH4
```{r}
pairwise.t.test(p_data_carbs$mass_per_mass_fuel[p_data_gas$pol == "ch4"], p_data_carbs$fuel[p_data_gas$pol == "ch4"], p.adj = "none")
```

---
title: "Startup Emissions Analysis - g pol / kg fuel "
...
```{r}
#notes:
## * Expected number of rows: 896 [25 pol x 34 tests + 1 pol x 8 tests (blanks #36-43, grav only) + 0 pol x 2 tests (full censor for bad QC on #8, 24) + 20 x 1 test (#44; no VOCs) + 9 pol x 2 tests (#1,30; no carbonyls - censored for bad QC)

...
```{r}
  ...
  ggplot() + 
        geom_point(data = pmco, aes(x = grav, y = co, colour = fuel), size = 2) +
...
```{r}
  ...
  ggplot() + 
        geom_point(data = pmbz, aes(x = grav, y = voc_benzene, colour = fuel), size = 2) +
...
```{r}
  ...
  ggplot() + 
        geom_point(data = pmto, aes(x = grav, y = voc_toluene, colour = fuel), size = 2) +
...
```{r}
  ...
  ggplot() + 
        geom_point(data = pmfd, aes(x = grav, y = formaldehyde, colour = fuel), size = 2) +
...
```{r}
  ...
  ggplot() + 
        geom_point(data = pmfd, aes(x = grav, y = acetaldehyde, colour = fuel), size = 2) +
...
```{r}
  ...
  ggplot() + 
        geom_point(data = pmco, aes(x = co, y = grav, colour = fuel), size = 2) +
...
```{r}
  ...
  ggplot() + 
        geom_point(data = cobz, aes(x = co, y = voc_benzene, colour = fuel), size = 2) +
          ylab("benzene EF (mg per startup event) ") +
          xlab("CO EF (mg per startup event)") +
          scale_color_hue(l=50, c=80) +
          scale_x_log10() +
...
```{r}
  ...
  ggplot() + 
        geom_point(data = coto, aes(x = co, y = voc_toluene, colour = fuel), size = 2) +
          ylab("toluene EF (mg per startup event)") +
          xlab("CO EF (mg per startup event)") +
          scale_color_hue(l=50, c=80) +
          scale_x_log10() +
...
```{r}
  ...
  ggplot() + 
        geom_point(data = cofd, aes(x = co, y = formaldehyde, colour = fuel), size = 2) +
          ylab("formaldehyde EF (mg per startup event)") +
          xlab("CO EF (mg per startup event)") +
          scale_color_hue(l=50, c=80) +
          scale_x_log10() +
...
```{r}
  ...
  ggplot() + 
        geom_point(data = coad, aes(x = co, y = acetaldehyde, colour = fuel), size = 2) +
          ylab("acetaldehyde EF (mg per startup event)") +
          xlab("CO EF (mg per startup event)") +
          scale_color_hue(l=50, c=80) +
          scale_x_log10() +

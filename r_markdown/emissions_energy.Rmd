...
ggplot(all_energy, aes(x = mean_mc, y = mass_pol_energy_mg, color = mc_level, shape = type)) +
  geom_point(size = 2) +
  theme_bw() +
  ...
  scale_x_continuous(breaks = c(5, 15, 25)) +
  labs(color = "MC Level", shape = "Fuel Shape") +
  geom_hline(aes(yintercept = 20), data=subset(all_energy, pol == "grav"), color = "red") +
  geom_hline(aes(yintercept = 20), data=subset(all_energy, pol == "co"), color = "red") +

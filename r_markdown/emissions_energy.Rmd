...
```{r, echo=TRUE, warning=FALSE, message=FALSE, results='markup', cache=FALSE}
  calc_constants <- readRDS("../r_files/calc_constants.RDS")
```
...
```{r, echo=TRUE, warning=FALSE, message=FALSE, results='markup', cache=FALSE}
  ...
  batch_wgts <- readRDS("../r_files/batch_wgts.RDS")
  batch_pot <- readRDS("../r_files/batch_pot.RDS")
  wood_wgts <- readRDS("../r_files/wood_wgts.RDS")
  wood_pot <- readRDS("../r_files/wood_pot.RDS")
```

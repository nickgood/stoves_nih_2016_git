...
voc <- readRDS("../r_files/voc_merged.RDS") #currently not complete data (emailed Arsineh on 6/21)
carbonyl <- readRDS("../r_files/ions_merged.RDS") #currently in wide format
grav <- readRDS("../r_files/grav_merged.RDS")
grav_test <- readRDS("../r_files/grav.RDS")
```

...
```{r}
  ...
  fivegas <- readRDS("../r_files/fivegas_merged.RDS")
  background <- readRDS("../r_files/background_co.RDS")
    bg_co <- background$bg
    bg_co_mean <- background$mean
  background <- readRDS("../r_files/background_co2.Rda")
    bg_co2 <- background$bg
    bg_co2_mean <- background$mean
  backgrounds <- readRDS("../r_files/background_ch4.Rda")

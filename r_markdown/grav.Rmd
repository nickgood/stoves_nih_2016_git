...
## Background-corrected concentration (ug/m3) 

```{r, echo=FALSE, warning=FALSE, message=FALSE, results='markup', cache=FALSE, fig.width=20, fig.height=15}
  ggplot(filter(grav, fuel_type!="background"), aes(id, conc_bgadj, colour = fuel_type)) +
  geom_point(size = 4) +
  theme_minimal() +
...
Test 26 (L2) has lower average flow. Pre-test flow was normal but post-test flow was low (`r flow$flow_delta[26]`). Potentially indicative of a clog in the line. Consider changing QC of this test to "maybe"?

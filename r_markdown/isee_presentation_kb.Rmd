    ...
    dplyr::mutate(stove = 
                  ...
                  stovecat = 
                    ...
                    forcats::fct_recode("insulated [improved] stoves" = "improved",
                                        ...
                                        "traditional [open] stoves" = "traditional"))
```
...
```{r aerosols_stove}
  isee_summarize(aerosols) %>% 
    dplyr::mutate(pol = ordered(pol, levels = c("ions",
                                                "elemental carbon",
                                                "organic carbon"))) %>% 
...
```{r gases_stoves}
  isee_summarize(co) %>% 
    isee_bar_charts(y_lab = y_label, color = c("#0072B2"))
```

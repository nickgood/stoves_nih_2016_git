...
```{r, echo=TRUE, warning=FALSE, message=FALSE, results='markup', cache=FALSE} 
  temp <- load.multifile(fldr = "../data/temp", pattern = "_TEMP.csv|_TEMP.CSV", inst = "temp")
...
```{r, echo=TRUE, warning=FALSE, message=FALSE, results='markup', cache=FALSE} 
  samples <- load.singlefiles("sample")
...
```{r, echo=TRUE, warning=FALSE, message=FALSE, results='markup', cache=FALSE} 
  data_1 <- load.singlefiles("data_1")
...
```{r, echo=TRUE, warning=FALSE, message=FALSE, results='markup', cache=FALSE} 
  data_2 <- load.singlefiles("data_2")

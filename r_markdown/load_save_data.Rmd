...
```{r, echo=TRUE, warning=FALSE, message=FALSE, results='markup', cache=FALSE}
  samples <- dplyr::mutate(samples,
                           stove = forcats::lvls_revalue(stove,
...
```{r, echo=TRUE, warning=FALSE, message=FALSE, results='markup', cache=FALSE}
  samples <- dplyr::mutate(samples,
                           fuel = forcats::lvls_revalue(fuel,
                                  c("Douglas Fir",
                                  "Oak",
                                  "Eucalyptus",
                                  "Lump Hardwood (Sm.)",
...
```{r, echo=TRUE, warning=FALSE, message=FALSE, results='markup', cache=FALSE}
  samples <- dplyr::mutate(samples,
                           stove_fuel = forcats::as_factor(paste(stove, ":", fuel))) %>%
                           ...
                           forcats::lvls_reorder(stove_fuel,
                                                 c(28, 30, 29, 7, 9, 8,
                                                   ...
                                                   10, 12, 11, 6, 5, 4,
                                                   21, 20, 19, 18, 17, 14,
                                                   13, 16, 15, 31, 23, 24, 22))) # set logical factor order
```

* Create aggregated fuel category

```{r, echo=TRUE, warning=FALSE, message=FALSE, results='markup', cache=FALSE}
  samples <- dplyr::mutate(samples, fuelcat = forcats::fct_collapse(fuel,
                                               wood = c("Oak",
                                                        "Eucalyptus",
                                                        "Douglas Fir"),
...
```{r, echo=TRUE, warning=FALSE, message=FALSE, results='markup', cache=FALSE}
  samples <- dplyr::mutate(samples,
             ...
             dplyr::mutate(stovecat = forcats::fct_collapse(stove,

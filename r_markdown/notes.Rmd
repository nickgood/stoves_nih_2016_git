...
```{r, echo=TRUE, warning=FALSE, message=FALSE, results='markup', cache=FALSE}
  samples <- readRDS("../r_files/data_fuel_prep.RDS")
...
```{r, echo=TRUE, warning=FALSE, message=FALSE, results='markup', cache=FALSE}
  test_id_date <-  dplyr::select(mc_test_log, id, date)  # get id and date
  
  # no notes_1 for this study
...
```{r, echo=TRUE, warning=FALSE, message=FALSE, results='markup', cache=FALSE}
  notes<- saveRDS(notes, file = "../r_files/notes.RDS")
```

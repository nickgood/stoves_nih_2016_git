...
```{r, echo=FALSE, warning=FALSE, message=FALSE, results='markup', cache=FALSE}
  ...
  ef_w <- dplyr::distinct(emission_factors) %>%
          ...
          dplyr::select(emission_factors, id, pol, energy_ef_comb) %>%
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, results='markup', cache=FALSE, fig.width = 14,  fig.height = 10}
  plot_cormap(dplyr::select(emission_factors, id, pol, energy_ef_comb), "spearman")
```

## Wood fuels

```{r, echo=FALSE, warning=FALSE, message=FALSE, results='markup', cache=FALSE, fig.width = 14,  fig.height = 10}
  plot_cormap(dplyr::select(dplyr::filter(emission_factors, fuelcat == "wood"),
                            id, pol, energy_ef_comb), "spearman")
```

## Charcoal fuels

```{r, echo=FALSE, warning=FALSE, message=FALSE, results='markup', cache=FALSE, fig.width = 14,  fig.height = 10}
  plot_cormap(dplyr::select(dplyr::filter(emission_factors, fuelcat == "charcoal"),
                            id, pol, energy_ef_comb), "spearman")
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, results='markup', cache=FALSE, fig.width = 14,  fig.height = 10}
  plot_cormap(dplyr::select(dplyr::filter(emission_factors, fuelcat == "pellets"),
                            id, pol, energy_ef_comb), "spearman")
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, results='markup', cache=FALSE, fig.width = 14,  fig.height = 10}
  plot_cormap(dplyr::select(dplyr::filter(emission_factors, fuelcat == "advanced"),
                            id, pol, energy_ef_comb), "spearman")
```

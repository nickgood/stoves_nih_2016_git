...
```{r, echo=FALSE, fig.height = 60, fig.width = 1}
  pah_samples %>%
...
* Fraction of samples that are negative after background correction: `r round(sum(pah_merged$conc <= 0, na.rm = TRUE) / nrow(pah_merged), 4)`.

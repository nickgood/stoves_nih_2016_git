...
## Pollutant concentrations before dilution

* plot pollutant concentrations before dilution
...
```{r}
  pol_conc <- pol_conc %>%
              ...
              dplyr::mutate(diluted_conc = value / dilution)
```

* plot pollutant concentrations after dilution

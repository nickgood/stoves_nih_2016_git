...
```{r}
  ...
  lsmeans((aov(mass_pol_per_startup_std ~ fuel_names, data = grav_means)), pairwise ~ fuel_names, adjust = "none")
...
```{r, echo=FALSE}
 ...
 # spearman's rho calculations
  ...
  ggplot(data = carbs, aes(x = formaldehyde, y = acetaldehyde)) + 
        geom_point(size = 5, aes(colour = fuel_names, shape = fuel_cat)) +
        geom_smooth(method = "lm", se = FALSE, color = "black") +
        geom_text(data = rhos, aes(x = 20, y = 15, label = val[1]), #all
                      color = 'black',  parse = TRUE,
                      size = 5) +
        geom_smooth(method = "lm", se = FALSE, aes(group = fuel_cat, color = fuel_cat)) +
        geom_text(data = rhos, aes(x = 25, y = 10, label = val[2]), #conv
                       color = 'red',  parse = TRUE,
                       size = 4) +
        geom_text(data = rhos, aes(x = 2.5, y = 4, label = val[3]), #nonconv
                       color = 'purple',  parse = TRUE,
                       size = 4) +
          ylab("acetaldehyde") +
          xlab("formaldehyde") +
...
```{r, echo=FALSE}
 ...
 # spearman's rho calculations
  ...
  ggplot(data = voc, aes(x = voc_benzene, y = voc_toluene)) + 
        geom_point(size = 5, aes(colour = fuel_names, shape = fuel_cat)) +
        geom_smooth(method = "lm", se = FALSE, color = "black") +
        geom_text(data = rhos, aes(x = 15, y = 2.5, label = val[1]),
                      color = 'black',  parse = TRUE,
                      size = 5) +
        geom_smooth(method = "lm", se = FALSE, aes(group = fuel_cat, color = fuel_cat)) +
        geom_text(data = rhos, aes(x = 5, y = 2.5, label = val[2]),
                       color = 'red',  parse = TRUE,
                       size = 4) +
        geom_text(data = rhos, aes(x = 4, y = 0.5, label = val[3]),
                       color = 'purple',  parse = TRUE,
                       size = 4) +
          ylab("toluene") +
          xlab("benzene") +
...
```{r, echo=FALSE}
 ...
 # spearman's rho calculations
  ...
  ggplot(data = pmfor, aes(x = grav, y = formaldehyde)) + 
        geom_point(size = 5, aes(colour = fuel_names, shape = fuel_cat)) +
        geom_smooth(method = "lm", se = FALSE, color = "black") +
        geom_text(data = rhos, aes(x = 380, y = 10, label = val[1]),
                      color = 'black',  parse = TRUE,
                      size = 5) +
        geom_smooth(method = "lm", se = FALSE, aes(group = fuel_cat, color = fuel_cat)) +
        geom_text(data = rhos, aes(x = 250, y = 16, label = val[2]),
                       color = 'red',  parse = TRUE,
                       size = 4) +
        geom_text(data = rhos, aes(x = 200, y = 3, label = val[3]),
                       color = 'purple',  parse = TRUE,
                       size = 4) +
          ylab("formaldehyde") +
          xlab("PM2.5") +
...
```{r, echo=FALSE}
 ...
 # spearman's rho calculations
  ...
  ggplot(data = pmacet, aes(x = grav, y = acetaldehyde)) + 
        geom_point(size = 5, aes(colour = fuel_names, shape = fuel_cat)) +
        geom_smooth(method = "lm", se = FALSE, color = "black") +
        geom_text(data = rhos, aes(x = 400, y = 10, label = val[1]),
                      color = 'black',  parse = TRUE,
                      size = 5) +
        geom_smooth(method = "lm", se = FALSE, aes(group = fuel_cat, color = fuel_cat)) +
        geom_text(data = rhos, aes(x = 250, y = 8, label = val[2]),
                       color = 'red',  parse = TRUE,
                       size = 4) +
        geom_text(data = rhos, aes(x = 200, y = 2, label = val[3]),
                       color = 'purple', parse = TRUE,
                       size = 4) +
          ylab("acetaldehyde") +
          xlab("PM2.5") +
 ...
 # spearman's rho calculations
  ...
  ggplot(data = pmbenz, aes(x = grav, y =voc_benzene)) + 
        ...
        geom_text(data = rhos, aes(x = 400, y = 10, label = val[1]),
                      ...
                      size = 5) +
        geom_smooth(method = "lm", se = FALSE, aes(group = fuel_cat, color = fuel_cat)) +
        geom_text(data = rhos, aes(x = 250, y = 10, label = val[2]),
                       color = 'red',  parse = TRUE,
                       size = 4) +
        geom_text(data = rhos, aes(x = 200, y = 2, label = val[3]),
                       color = 'purple',  parse = TRUE,
...
```{r, echo=FALSE}
 ...
 # spearman's rho calculations
  ...
  ggplot(data = pmtol, aes(x = grav, y =voc_toluene)) + 
        geom_point(size = 5, aes(colour = fuel_names, shape = fuel_cat)) +
        geom_smooth(method = "lm", se = FALSE, color = "black") +
        geom_text(data = rhos, aes(x = 350, y = 2.25, label = val[1]),
                      color = 'black',  parse = TRUE,
                      size = 5) +
        geom_smooth(method = "lm", se = FALSE, aes(group = fuel_cat, color = fuel_cat)) +
        geom_text(data = rhos, aes(x = 200, y = 2.8, label = val[2]),
                       color = 'red',  parse = TRUE,
                       size = 4) +
        geom_text(data = rhos, aes(x = 200, y = 0.7, label = val[3]),
                       color = 'purple',  parse = TRUE,
                       size = 4) +
          ylab("toluene") +
          xlab("PM2.5") +
...
```{r, echo=FALSE}
 ...
 # spearman's rho calculations
  ...
  ggplot(data = cofor, aes(x = co, y = formaldehyde)) + 
        geom_point(size = 5, aes(colour = fuel_names, shape = fuel_cat)) +
        geom_smooth(method = "lm", se = FALSE, color = "black") +
        geom_text(data = rhos, aes(x = 500, y = 15, label = val[1]),
                      color = 'black',  parse = TRUE,
                      size = 5) +
          ylab("formaldehyde") +
        geom_smooth(method = "lm", se = FALSE, aes(group = fuel_cat, color = fuel_cat)) +
        geom_text(data = rhos, aes(x = 750, y = 13, label = val[2]),
                       color = 'red',  parse = TRUE,
                       size = 4) +
        geom_text(data = rhos, aes(x = 200, y = 2, label = val[3]),
                       color = 'purple',  parse = TRUE,
...
```{r, echo=FALSE}
 ...
 # spearman's rho calculations
  ...
  ggplot(data = coacet, aes(x = co, y = acetaldehyde)) + 
        geom_point(size = 5, aes(colour = fuel_names, shape = fuel_cat)) +
        geom_smooth(method = "lm", se = FALSE, color = "black") +
        geom_text(data = rhos, aes(x = 600, y = 10, label = val[1]),
                      color = 'black',  parse = TRUE,
                      size = 5) +
        geom_smooth(method = "lm", se = FALSE, aes(group = fuel_cat, color = fuel_cat)) +
        geom_text(data = rhos, aes(x = 750, y = 5, label = val[2]),
                       color = 'red',  parse = TRUE,
                       size = 4) +
        geom_text(data = rhos, aes(x = 250, y = 1.25, label = val[3]),
                       color = 'purple',  parse = TRUE,
                       size = 4) +
          ylab("acetaldehyde") +
          xlab("CO") +
...
```{r, echo=FALSE}
 ...
 # spearman's rho calculations
  ...
  ggplot(data = cobenz, aes(x = co, y = voc_benzene)) + 
        geom_point(size = 5, aes(colour = fuel_names, shape = fuel_cat)) +
        geom_smooth(method = "lm", se = FALSE, color = "black") +
        geom_text(data = rhos, aes(x = 450, y = 7.5, label = val[1]),
                      color = 'black',  parse = TRUE,
                      size = 5) +
        geom_smooth(method = "lm", se = FALSE, aes(group = fuel_cat, color = fuel_cat)) +
        geom_text(data = rhos, aes(x = 600, y = 11, label = val[2]),
                       color = 'red',  parse = TRUE,
                       size = 4) +
        geom_text(data = rhos, aes(x = 200, y = 1.25, label = val[3]),
                       color = 'purple',  parse = TRUE,
                       size = 4) +
          ylab("benzene") +
          xlab("CO") +
...
```{r, echo=FALSE}
 ...
 # spearman's rho calculations
  ...
  ggplot(data = cotol, aes(x = co, y = voc_toluene)) + 
        geom_point(size = 5, aes(colour = fuel_names, shape = fuel_cat)) +
        geom_smooth(method = "lm", se = FALSE, color = "black") +
        geom_text(data = rhos, aes(x = 500, y = 1.5, label = val[1]),
                      color = 'black',  parse = TRUE,
                      size = 5) +
        geom_smooth(method = "lm", se = FALSE, aes(group = fuel_cat, color = fuel_cat)) +
        geom_text(data = rhos, aes(x = 750, y = 3, label = val[2]),
                       color = 'red',  parse = TRUE,
                       size = 4) +
        geom_text(data = rhos, aes(x = 225, y = 0.5, label = val[3]),
                       color = 'purple',  parse = TRUE,
                       size = 4) +
          ylab("toluene") +
          xlab("CO") +

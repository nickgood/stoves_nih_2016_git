...
```{r fig.width = 12, fig.height = 8}
  pol_cats <- mean_per_startup %>%
              ...
              dplyr::mutate(pol = factor(pol, levels = c("formaldehyde", "acetaldehyde", "benzene", "toluene", "ethylbenzene", "xylenes")))

cbPalette <- c("#E69F00", "#009E73", "#993333", "#0072B2", "#999999", "#D55E00")

...
pmco_pertest <- dplyr::filter(per_test, grepl('^grav$|^co$', pol)) %>%
 ...
 # spearman's rho calculations
  ...
  rhos <- data.frame(c(rho_all, rho_pear))
  colnames(rhos) <- "val"
  ...
  ggplot() + 
        ...
        geom_text(data = rhos, aes(x = 50, y = 50, label = text[1]), 
                      ...
                      size = 5) +
            geom_text(data = rhos, aes(x = 50, y = 45, label = text[2]), 
                      color = 'black',  parse = TRUE,
                      size = 5) +
          ylab("CO") +
          xlab("PM2.5") +
...
```{r, echo=FALSE, fig.width = 6}
 ...
 # spearman's rho calculations
  ...
  ggplot(data = carbs, aes(x = formaldehyde, y = acetaldehyde)) + 
        ...
        geom_text(data = rhos, aes(x = 0.5, y = 0.5, label = val[1]), #all
                      color = 'black',  parse = TRUE,
                      size = 5) +
          ylab("acetaldehyde") +
          xlab("formaldehyde") +
...
```{r, echo=FALSE, fig.width = 6}
 ...
 # spearman's rho calculations
  ...
  r_noncon <- cor(voc$voc_benzene[voc$fuel_cat == "nonconventional"], voc$voc_toluene[voc$fuel_cat == "nonconventional"], method = "spearman")
  rhos <- data.frame(c(rho_all, r_conv, r_noncon))
  colnames(rhos) <- "val"
  rhos$val <- round(rhos$val, 2)
  ...
  ggplot(data = voc, aes(x = voc_benzene, y = voc_toluene)) + 
        geom_point(size = 5, aes(colour = fuel_names, shape = fuel_cat)) +
        geom_smooth(method = "lm", se = FALSE, color = "black") +
        geom_text(data = rhos, aes(x = 0.75, y = 0.2, label = val[1]),
                      color = 'black',  parse = TRUE,
                      size = 5) +
          ylab("toluene") +
          xlab("benzene") +
...
```{r, echo=FALSE, fig.width = 6}
 ...
 # spearman's rho calculations
  ...
  ggplot(data = pmfor, aes(x = grav, y = formaldehyde)) + 
        geom_point(size = 5, aes(colour = fuel_names, shape = fuel_cat)) +
        geom_smooth(method = "lm", se = FALSE, color = "black") +
        geom_text(data = rhos, aes(x = 15, y = 0.65, label = val[1]),
                      color = 'black',  parse = TRUE,
                      size = 5) +
          ylab("formaldehyde") +
          xlab("PM2.5") +
...
```{r, echo=FALSE, fig.width = 6}
 ...
 # spearman's rho calculations
  ...
  ggplot(data = pmacet, aes(x = grav, y = acetaldehyde)) + 
        geom_point(size = 5, aes(colour = fuel_names, shape = fuel_cat)) +
        geom_smooth(method = "lm", se = FALSE, color = "black") +
        geom_text(data = rhos, aes(x = 15, y = 0.35, label = val[1]),
                      color = 'black',  parse = TRUE,
                      size = 5) +
          ylab("acetaldehyde") +
          xlab("PM2.5") +
...
```{r, echo=FALSE, fig.width = 6}
 ...
 # spearman's rho calculations
  ...
  ggplot(data = pmbenz, aes(x = grav, y =voc_benzene)) + 
        geom_point(size = 5, aes(colour = fuel_names, shape = fuel_cat)) +
        geom_smooth(method = "lm", se = FALSE, color = "black") +
        geom_text(data = rhos, aes(x = 15, y = 0.5, label = val[1]),
                      color = 'black',  parse = TRUE,
                      size = 5) +
          ylab("benzene") +
          xlab("PM2.5") +
...
```{r, echo=FALSE, fig.width = 6}
 ...
 # spearman's rho calculations
  ...
  ggplot(data = pmtol, aes(x = grav, y = voc_toluene)) + 
        geom_point(size = 5, aes(colour = fuel_names, shape = fuel_cat)) +
        geom_smooth(method = "lm", se = FALSE, color = "black") +
        geom_text(data = rhos, aes(x = 15, y = 0.12, label = val[1]),
                      color = 'black',  parse = TRUE,
                      size = 5) +
          ylab("toluene") +
          xlab("PM2.5") +
...
```{r, echo=FALSE, fig.width = 6}
 ...
 # spearman's rho calculations
  ...
  ggplot(data = cofor, aes(x = co, y = formaldehyde)) + 
        geom_point(size = 5, aes(colour = fuel_names, shape = fuel_cat)) +
        geom_smooth(method = "lm", se = FALSE, color = "black") +
        geom_text(data = rhos, aes(x = 30, y = 0.75, label = val[1]),
                      color = 'black',  parse = TRUE,
                      size = 5) +
        ylab("formaldehyde") +
          xlab("CO") +
...
```{r, echo=FALSE, fig.width = 6}
 ...
 # spearman's rho calculations
  ...
  ggplot(data = coacet, aes(x = co, y = acetaldehyde)) + 
        geom_point(size = 5, aes(colour = fuel_names, shape = fuel_cat)) +
        geom_smooth(method = "lm", se = FALSE, color = "black") +
        geom_text(data = rhos, aes(x = 30, y = 0.4, label = val[1]),
                      color = 'black',  parse = TRUE,
                      size = 5) +
          ylab("acetaldehyde") +
          xlab("CO") +
...
```{r, echo=FALSE, fig.width = 6}
 ...
 # spearman's rho calculations
  ...
  ggplot(data = cobenz, aes(x = co, y = voc_benzene)) + 
        geom_point(size = 5, aes(colour = fuel_names, shape = fuel_cat)) +
        geom_smooth(method = "lm", se = FALSE, color = "black") +
        geom_text(data = rhos, aes(x = 32, y = 0.5, label = val[1]),
                      color = 'black',  parse = TRUE,
                      size = 5) +
          ylab("benzene") +
          xlab("CO") +
...
```{r, echo=FALSE, fig.width = 6}
 ...
 # spearman's rho calculations
  ...
  ggplot(data = cotol, aes(x = co, y = voc_toluene)) + 
        geom_point(size = 5, aes(colour = fuel_names, shape = fuel_cat)) +
        geom_smooth(method = "lm", se = FALSE, color = "black") +
        geom_text(data = rhos, aes(x = 35, y = 0.15, label = val[1]),
                      color = 'black',  parse = TRUE,
                      size = 5) +
          ylab("toluene") +
          xlab("CO") +

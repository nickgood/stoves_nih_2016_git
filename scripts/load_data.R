...
# load libraries
  ...
  pacman::p_load(tidyverse, readxl, reshape) # who is still using reshape?! ugh!
#________________________________________________________

#________________________________________________________
# load co2 file (dilution data)
...
load_ecoc_file <- function(file){
  ...
  # determine test type (test, pilot or NA)
...
load_trans_file <- function(file, sheet = "Transmissometer Log"){
  ...
  col_names = c("id_filter",
                ...
                "phpa_pre",
                "id_blank_diff_pre",
                "uv_front_blank_diff_pre",
                "ir_front_blank_diff_pre",
                "uv_back_blank_diff_pre",
                "ir_back_blank_diff_pre",
                "id_sample_diff_pre",
                "uv_front_sample_diff_pre",
                "ir_front_sample_diff_pre",
                "uv_back_sample_diff_pre",
                "ir_back_sample_diff_pre",
                "uv_blank_pre",
                "ir_blank_pre",
                "uv_sample_pre",
                "ir_sample_pre",
                ...
                "phpa_post",
                "id_blank_diff_post",
                "uv_front_blank_diff_post",
                "ir_front_blank_diff_post",
                "uv_back_blank_diff_post",
                "ir_back_blank_diff_post",
                "id_sample_diff_post",
                "uv_front_sample_diff_post",
                "ir_front_sample_diff_post",
                "uv_back_sample_diff_post",
                "ir_back_sample_diff_post",
                "uv_blank_post",
                "ir_blank_post",
                "uv_sample_post",
                "ir_sample_post",

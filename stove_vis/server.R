...
#_______________________________________________________________________________
  ...
  { 		d_left <- dplyr::filter_(df, ~pol == input$y_pol, ~units ==  input$y_metric)
  d_bottom <- dplyr::filter_(df, ~pol == input$x_pol, ~units ==  input$x_metric)
  p_data <- dplyr::inner_join(d_left, d_bottom, by = "id")
